...
import fsbindings as fsutils
from fsbindings import AsegStatsParser, BadFileError, aseglogger
...
def options_parse():
    ...
    parser.add_option('', '--append', dest='appendflag', action='store_true', default=False, help=h_append)
